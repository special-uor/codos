...
fimon2 <- tibble::tibble(age_calBP = fimon$age_cal_yr_BP,
                         ...
                         present_t = mean(quinto_vicentino_tmp),
                         recon_mi = fimon$MI,
...
- Year: `1961`
- Sunshine fraction: [`CRU TS 4.04`] $ + \texttt{Cld}_\text{anomalies}$ 
- Temperature:  [`CRU TS 4.04`] $ + {Tmp}_\text{anomalies}$
