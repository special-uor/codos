...
```{r co2-comparison_fig, echo = FALSE}
...
```{r tmp-anomalies-modern_fig, echo = FALSE, fig.height = 5}
...
```{r tmp-anomalies-ex1_fig, fig.height = 5, echo = FALSE}
...
```{r tmp-anomalies-ex2_fig, fig.height = 5, echo = FALSE}
...
```{r cld_anomalies_fig, echo = FALSE, eval = TRUE}
tibble::tibble(x = padul$age_cal_yr_BP,
...
```{r pet-comparison-ex1_fig, echo = FALSE}
tibble::tibble(x = rep(seq_len(365), 3),
...
Padul: PET for age = `r padul[272, 1]` cal yr BP
```{r pet-comparison-ex2_fig, echo = FALSE}
tibble::tibble(x = rep(seq_len(365), 3),
               y = c(padul_pet_modern,
                     padul_pet_tmp[272][[1]],
...
```{r mi-comparison_fig, echo = FALSE, eval = FALSE}
...
```{r modern-pet_fig, echo = FALSE, eval = TRUE}
tibble::tibble(x = seq_len(365),
               y = padul_pet_modern) %>%
  ggplot2::ggplot(ggplot2::aes(x, y)) +
  ggplot2::geom_line() +
...
```{r pet-all-approaches_fig, echo = FALSE}
tibble::tibble(x = rep(seq_len(365), 5),
...
Padul: PET for age = `r padul[169, 1]` cal yr BP
```{r pet-all-approaches-ex1_fig, echo = FALSE}
tibble::tibble(x = rep(seq_len(365), 5),
               y = c(padul_pet_tmp[169][[1]] - padul_pet_modern,
...
Padul: PET for age = `r padul[272, 1]` cal yr BP
```{r pet-all-approaches-ex2_fig, echo = FALSE}
tibble::tibble(x = rep(seq_len(365), 5),
               y = c(padul_pet_tmp[272][[1]] - padul_pet_modern,
...
```{r recon-vs-corrected-mi_fig, echo = FALSE}
tibble::tibble(x = rep(padul2$age_calBP, 3),
               y = c(padul2$recon_mi, 
                     padul2$corr_mi,
                     padul2$corr_mi_20th),
...
```{r recon-vs-corrected-mi-5k-subset_fig, echo = FALSE}
tibble::tibble(x = rep(padul2$age_calBP, 3),
               y = c(padul2$recon_mi, 
                     padul2$corr_mi,
                     padul2$corr_mi_20th),
...
```{r recon-vs-corrected-mi-with-co2-tmp_fig, echo = FALSE, eval = TRUE}
...
```{r recon-vs-corrected-mi-with-co2-tmp-5k-subset_fig, echo = FALSE, eval = TRUE}
tibble::tibble(x = rep(padul2$age_calBP, 2),
               y = c(padul2$recon_mi,
                     padul2$corr_mi),
               co2 = rep(padul2$past_co2 / 100, 2),
...
```{r recon-vs-corrected-pann_fig, echo = FALSE}
tibble::tibble(x = rep(padul2$age_calBP, 3),
               y = c(padul$P_ann, 
                     padul2$corr_P_ann,
...
```{r recon-vs-corrected-pann-5k-subset_fig, echo = FALSE}
tibble::tibble(x = rep(padul2$age_calBP, 3),
               y = c(padul$P_ann, 
                     padul2$corr_P_ann,
                     padul2$corr_P_ann_20th),
...
```{r recon-vs-corrected-pann-with-tmp-anomalies_fig, echo = FALSE, eval = TRUE}
tibble::tibble(x = rep(padul$age_cal_yr_BP, 3),
               y = c(padul$P_ann, 
                     padul_corrected_pr,
...
```{r recon-vs-corrected-pann-with-tmp-anomalies-22k-subset_fig, echo = FALSE, eval = TRUE}
tibble::tibble(x = rep(padul$age_cal_yr_BP, 3),
               y = c(padul$P_ann, 
                     padul_corrected_pr,
                     padul_corrected_pr_20th),
...
```{r recon-vs-corrected-pann-with-cld-anomalies_fig, echo = FALSE, eval = TRUE}
tibble::tibble(x = rep(padul$age_cal_yr_BP, 3),
               y = c(padul$P_ann, 
                     padul_corrected_pr_cld,
                     padul_corrected_pr_cld_20th),
...
```{r recon-vs-corrected-pann-with-cld-anomalies-22k-subset_fig, echo = FALSE, eval = TRUE}
tibble::tibble(x = rep(padul$age_cal_yr_BP, 3),
               y = c(padul$P_ann, 
                     padul_corrected_pr_cld,
                     padul_corrected_pr_cld_20th),
...
```{r recon-vs-corrected-pann-with-orbital-params_fig, echo = FALSE, eval = TRUE}
tibble::tibble(x = rep(padul$age_cal_yr_BP, 3),
               y = c(padul$P_ann, 
                     padul_corrected_pr_orb_params,
                     padul_corrected_pr_orb_params_20th),
...
```{r recon-vs-corrected-pann-with-orbital-params-22k-subset_fig, echo = FALSE, eval = TRUE}
tibble::tibble(x = rep(padul$age_cal_yr_BP, 3),
               y = c(padul$P_ann, 
                     padul_corrected_pr_orb_params,
                     padul_corrected_pr_orb_params_20th),
...
```{r recon-vs-corrected-pann-with-tmp-cld-anomalies_fig, echo = FALSE, eval = TRUE}
tibble::tibble(x = rep(padul$age_cal_yr_BP, 3),
               y = c(padul$P_ann, 
...
```{r recon-vs-corrected-pann-with-tmp-cld-anomalies-22k-subset_fig, echo = FALSE, eval = TRUE}
tibble::tibble(x = rep(padul$age_cal_yr_BP, 3),
               y = c(padul$P_ann, 
                     padul_corrected_pr_tmp_cld,
                     padul_corrected_pr_tmp_cld_20th),
...
```{r recon-vs-corrected-pann-with-anomalies-orb-params_fig, echo = FALSE, eval = TRUE}
tibble::tibble(x = rep(padul$age_cal_yr_BP, 3),
               y = c(padul$P_ann, 
...
```{r recon-vs-corrected-pann-with-anomalies-orb-params-22k-subset_fig, echo = FALSE, eval = TRUE}
tibble::tibble(x = rep(padul$age_cal_yr_BP, 3),
               y = c(padul$P_ann, 
                     padul_corrected_pr_ultimate,
                     padul_corrected_pr_ultimate_20th),
...
```{r recon-vs-corrected-pann-all_fig, echo = FALSE, eval = TRUE}
...
```{r recon-vs-corrected-pann-all-22k-subset_fig, echo = FALSE, eval = TRUE}
tibble::tibble(x = rep(padul$age_cal_yr_BP, 7),
               y = c(padul$P_ann, 
                     padul2$corr_P_ann,
                     padul_corrected_pr,
...
```{r a3-5k-subset_fig, echo = FALSE, eval = TRUE}
tibble::tibble(x = rep(padul2$age_calBP, 2),
               y = c(padul2$recon_mi,
                     padul2$corr_mi_loess),
               co2 = rep(padul2$past_co2_loess / 100, 2),
...
```{r a4-5k-subset_fig, echo = FALSE, eval = TRUE}
tibble::tibble(x = rep(padul2$age_calBP, 2),
                     y = c(padul2$past_co2,
                           padul2$past_co2_loess),
                     var = rep(c("Mean", 
...
```{r a4-500-subset_fig, echo = FALSE, eval = TRUE}
tibble::tibble(x = rep(padul2$age_calBP, 2),
                     y = c(padul2$past_co2,
                           padul2$past_co2_loess),
                     var = rep(c("Mean", 
