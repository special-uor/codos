...
#' \dontrun{
#'     hex_logo()
#'     hex_logo("inst/images/cloud.png",
#'              output = "inst/images/logo3.png")
#' }
hex_logo <- function(subplot = system.file("images/cloud.png",
                                           package = "codos"),
                     dpi = 600,
                     h_color = "#000000",
                     h_fill = "#C6DCFA",
